...
import { ADD_ADDITIONAL_GUEST } from './action';
...
const initialSelectedBookingState = {
  ...
  switch (action.type) {
    case 'SET_SELECTED_DATES':
      ...
      return {
        ...
        daysCount: diff, // Store the days count
      };
    default:
      return state;
  }
...
const selectedBookingReducer = (state = { selectedBooking: null }, action) => {
  console.log('Booking reducer action:', action); // Log every action
