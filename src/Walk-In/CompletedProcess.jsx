      ...
      <div className="w-full border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          ...
          <div className="hidden md:flex justify-between items-start gap-6">
            <div className="flex-1">
              <div className="flex items-start">
                ...
                <div>
                  <h1 className="text-2xl text-black font-bold">Reservation Successful</h1>
          ...
          <div className="flex flex-col md:hidden">
            <div className="mb-4">
              <div className="flex items-start">
                ...
                <div>
                  <h1 className="text-xl text-black font-bold">Reservation Successful</h1>
                  <p className="text-black text-sm mt-1">Your reservation has been confirmed</p>
            ...
            <p className="text-black text-xs mt-3 text-center">
              A confirmation email has been sent to {guest.emailid}
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
          ...
          <div className="p-4 sm:p-6">
            <h2 className="text-lg font-semibold mb-4 sm:mb-6">Guest Details</h2>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 break-words">{guest.clienttype}</p>
              </div>
              <div className="col-span-2">
                <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">
                  Email
                </p>
                <p className="font-semibold text-gray-900 break-words">{guest.emailid}</p>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6">
            <h2 className="text-lg font-semibold mb-4 sm:mb-6">Stay Details</h2>
...
//                   Your reservation has been confirmed and a confirmation email
//                   has been sent to {guest.emailid}
//                 </p>
//                 <div>
...
//                 <p className="font-semibold text-gray-900">
//                   {guest.firstname.charAt(0).toUpperCase() +
//                     guest.firstname.slice(1).toLowerCase()}
//                 </p>
//               </div>
//               <div>
//                 <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">
...
//                 <p className="font-semibold text-gray-900">
//                   {guest.lastname.charAt(0).toUpperCase() +
//                     guest.lastname.slice(1).toLowerCase()}
//                 </p>
//               </div>
...
//           <button
//             onClick={handlecheckin}
//             className="bg-purple-500 text-white px-16 py-3 rounded-md text-sm font-medium hover:bg-purple-800  shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-transform duration-200"
//           >
//             Continue to Home
//           </button>
//         </div>
