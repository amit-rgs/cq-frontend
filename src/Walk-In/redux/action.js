...
export const setModifyDates = (dates) => {
  const [checkInDate, checkOutDate] = dates;
  const diff = Math.ceil((checkOutDate - checkInDate) / (1000 * 3600 * 24));
...
// Add to your action.js
export const INIT_ADDITIONAL_GUESTS = 'INIT_ADDITIONAL_GUESTS';

export const initAdditionalGuests = (guests) => ({
  type: INIT_ADDITIONAL_GUESTS,
  payload: guests,
});
